<template>
    <div class="relative flex items-center justify-center min-h-screen bg-black text-yellow-300 px-4 md:px-8">
      <div class="absolute inset-0 flex items-center justify-center">
        <img
          src="/public/G.svg" 
          alt="Large G"
          class="w-auto h-[70%] md:h-[70%]"
        />
      </div>
      ...
      <div class="relative z-10 flex items-center justify-center flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8">
        ...
        <div class="">
          <h2 class="text-2xl font-serif md:text-3xl lg:text-4xl font-bold text-yellow">Our History<span><img src="/public/spoon.svg"></span></h2>
          <p class="mt-4 text-xs md:text-sm lg:text-base text-gray-400">
            Adipiscing tempus ullamcorper lobortis odio tellus <br> arcu volutpat. Risus placerat morbi  volutpat <br> habitasse interdum mi aliquam.
          </p>
          <button class="mt-6 px-4 py-2 md:px-6 md:py-2 bg-yellow hover:border border-yellow rounded font-serif">Know More</button>
        </div>
      </div>
    </div>
  </template>
